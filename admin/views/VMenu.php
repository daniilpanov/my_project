<div class="checkYourDoing">
    ...
    <a class="doing" href="?doing=create" title="Создать"><i class="icon-edit icon-large"></i></a>
    <a class="doing" href="?doing=seeFav" title="Быстрый доступ"><i class="icon-book icon-large"></i></a>
    <a class="doing" href="?doing=addFav" title="Редактировать быстрый доступ"><i class="icon-list-alt icon-large"></i></a>
