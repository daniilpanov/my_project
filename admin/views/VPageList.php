...
$admin_pages = $vcreateeditpage->getAllPages(true);
?>
...
<div class="admin_pages">
    <div id="list_table">
        ...
        <?php
        foreach ($admin_pages as $value)
        {?>

            <div class="row list_table_row">
                <div class="col-md-3">
                    <?php echo "<a href='?editPage={$value['id']}&admin=true'><i class='{$value['menu_icon']} {$value['icon_size']}'></i>{$value['menu_name']}</a><br>";?>
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-2"><?=date("d.m.Y \в H:i:s",$value['created'])?></div>
                <div class="col-md-2">
