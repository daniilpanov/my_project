...
INSERT INTO `constants` VALUES (1,5);
...
INSERT INTO `pages` VALUES (2,'The main page of site ’MY_PROJECT’',15,0,'Main','Main page','icon-glass','icon-1x',2,'1','Main','Hello!!!',1527412988,1527537272,'1'),(3,'Главная страница сайта ’MY_PROJECT’',13,0,'Главная','Главная страница','icon-glass','icon-1x',1,'1','Главная','Привет!!!',1527412613,1527537312,'1'),(27,'Это &mdash; пример страницы №1',16,3,'Пример, страница','Пример страницы №1','icon-tasks','icon-large',1,'1','Пример страницы №1','Это &mdash; пример страницы №1',1527879985,NULL,'1'),(28,'This is example page',17,2,'Example, page','Example page','icon-tasks','icon-large',2,'1','Example page №1','This is example page',1527880076,NULL,'1'),(29,'',18,28,'','','icon-beaker','icon-large',2,'1','test','',1527880172,NULL,'1');
...
-- Dump completed on 2018-06-01 22:28:33
