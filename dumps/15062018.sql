...
--
-- Table structure for table `help_home`
--

DROP TABLE IF EXISTS `help_home`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `help_home` (
  `name` varchar(255) NOT NULL,
  `value` mediumtext NOT NULL,
  `translate` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `help_home`
--

LOCK TABLES `help_home` WRITE;
/*!40000 ALTER TABLE `help_home` DISABLE KEYS */;
INSERT INTO `help_home` VALUES ('help','help page','помощь'),('home','main page','главная страница');
/*!40000 ALTER TABLE `help_home` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-06-15 23:11:53
