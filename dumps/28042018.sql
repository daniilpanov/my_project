...
INSERT INTO `menu` VALUES (1,'icon-beaker','меню 1',0,1524857825,'icon-large'),(3,'','меню 2',0,1524908892,'icon-large');
...
INSERT INTO `pages` VALUES (1,'Главная','Главная','Главная',1524857476,1524909296,'','','','icon-3x',1),(2,'Пример','Пример','Пример',1504795508,1524857561,'','','','icon-large',3);
...
-- Dump completed on 2018-04-28 18:29:39
